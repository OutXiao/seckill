...
function del(id) {
    ...
    if (r == true) {
        $.ajax({
            url: "http://106.12.210.46:8060/api/admin/video/delVideo",
            type: "post",
            data: {"id": id},
...
$("#addVideo").click(function () {
    ...
    $.ajax({
        type: "post",
        url: "http://106.12.210.46:8060/api/admin/video/addVideo",
        cache: false,  //禁用缓存
        data: formData,
        contentType: false,
        processData: false,
...
function editVideo(id) {
    $.ajax({
        type: "post",
        url: "http://106.12.210.46:8060/api/admin/video/getSingleVideoById",
        data: {"id": id},
        headers: {"Authorization": info.token},
        success: function (data) {
...
$("#editVideo").click(function () {
    ...
    $.ajax({
        type: "post",
        url: "http://106.12.210.46:8060/api/admin/video/editVideo",
        data: {
            "id": editId,
